 ...
 * @Description: GEMM for Amphere GPU.
 * @FilePath: /GPU-experiments/src/ampere_sgemm.cu
 */
...
void sgemm_128x128x8_kernel(const float *A,
     ...
     * matrix A: 128 * 8 * 4Byte/item * double buffer = 8KB
    ...
    // 32 threads per warp, lane_id is th0, th1, or thn
    // warp id is the warp0, warp1 or warpn
    ...
    // A_tile & B_tile ldg pointer, implicit transpse
